...
<body>
    ...
    <div style="background-color: #FAFAFA; width: 100%; font-family: 'Arial', 'Helvetica Neue', 'Helvetica', sans-serif; box-sizing: border-box; padding-bottom: 25px; margin: 0;">
        ...
        <img style="display: inline-block; height: 30px; width: auto; margin-left: auto; margin-right: auto;" alt="Logo" src="{{ asset('images/logo.jpg') }}" height="150" width="150" />
        </div>
        ...
        <p style="margin-bottom: 25px;">{{ $details['title'] }}</p>
        <p style="margin-bottom: 40px; color: #555; line-height: 25px; font-size: 15px">{!! nl2br($details['body']) !!}</p>
        ...
        <p style="margin-top: 0px;">L'équipe SAPP MOBILE !</p>
            ...
            <p style="color: #777777; padding: 0 25px; max-width: 400px; box-sizing: border-box; margin-left: auto; margin-right: auto; font-size: 10px; text-align: center;"><em>SAPP MOBILE © {{ date('Y') }}</em></p>
        </div>
