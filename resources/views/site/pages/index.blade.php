...
<body class="container-fluid" style="background-color: var(--first-color); height: 100vh">

    <div class="row h-100" style="height: 100vh">
        <div class="mx-auto my-auto">
            <h1 class="text-center text-white- fw-1000" style="font-size: 80px; text-shadow: 0px 10px #ff0000;">
                SAPP MOBILE WEB SITE
            </h1>
        </div>
    </div>
</body>
