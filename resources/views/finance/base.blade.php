                    ...
                    <div class="sidebar">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <ul class="nav_list">
                                    <li class="nav_item "><a href="{{ route('finance.generals', ["type" => "day"]) }}" class="nav_link">Jour</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.generals', ["type" => "month"]) }}" class="nav_link">Mois</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.generals', ["type" => "year"]) }}" class="nav_link">Année</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.generals', ["type" => "interval"]) }}" class="nav_link">Période</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="nav_list">
                                    <li class="nav_item "><a href="{{ route('finance.conducteurs', ["type" => "day"]) }}" class="nav_link">Jour</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.conducteurs', ["type" => "month"]) }}" class="nav_link">Mois</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.conducteurs', ["type" => "year"]) }}" class="nav_link">Année</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.conducteurs', ["type" => "interval"]) }}" class="nav_link">Période</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="nav_list">
                                    <li class="nav_item "><a href="{{ route('finance.vehicules', ["type" => "day"]) }}" class="nav_link">Jour</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.vehicules', ["type" => "month"]) }}" class="nav_link">Mois</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.vehicules', ["type" => "year"]) }}" class="nav_link">Année</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.vehicules', ["type" => "interval"]) }}" class="nav_link">Période</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="nav_list">
                                    <li class="nav_item "><a href="{{ route('finance.entreprises', ["type" => "day"]) }}" class="nav_link">Jour</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.entreprises', ["type" => "month"]) }}" class="nav_link">Mois</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.entreprises', ["type" => "year"]) }}" class="nav_link">Année</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.entreprises', ["type" => "interval"]) }}" class="nav_link">Période</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="nav_list">
                                    <li class="nav_item "><a href="{{ route('finance.clients', ["type" => "day"]) }}" class="nav_link">Jour</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.clients', ["type" => "month"]) }}" class="nav_link">Mois</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.clients', ["type" => "year"]) }}" class="nav_link">Année</a></li>
                                    <li class="nav_item "><a href="{{ route('finance.clients', ["type" => "interval"]) }}" class="nav_link">Période</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="bg-primary- fixed-top text-white shadow-sm fw-bold text-center" style="padding: 1vh 2vh;">
                            <div class="hstack">
                                ...
                                <div class="hstack ms-auto">
                                    ...
                                    <a href="{{ route('finance.disconnect') }}"><i class="uil uil-sign-out-alt fs-3 text-white"></i></a>
                                </div>
                            </div>
                        </div>
