...
<body>
    ...
    <div style="background-color: #FAFAFA; width: 100%; font-family: 'Arial', 'Helvetica Neue', 'Helvetica', sans-serif; box-sizing: border-box; padding-bottom: 25px; margin: 0;">
        ...
        <p style="margin-bottom: 55px; color: #222; text-align: justify;"><?php echo nl2br($details['body']); ?></p>
...
<?php /**PATH G:\Projets\Laravel\sapp_api\resources\views/emails/mailSender.blade.php ENDPATH**/ ?>