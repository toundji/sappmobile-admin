        ...
        <?php $__currentLoopData = $publications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $publication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-6 " >
                <div class="bg-white rounded border pb-1">
                    <img src="<?php echo e(asset($publication->image)); ?>" alt="" class="w-100" style="object-fit: cover; height: 200px">
                    <div class="mx-4 my-3">
...
<?php /**PATH G:\Projets\Laravel\sapp_api\resources\views/livewire/admin/other/publications.blade.php ENDPATH**/ ?>